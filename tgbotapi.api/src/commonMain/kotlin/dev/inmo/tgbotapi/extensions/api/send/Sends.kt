...
/**
 * Will execute [sendRichMessage] request
...
@Deprecated(
    ...
    ReplaceWith(
        ...
        "dev.inmo.tgbotapi.types.EphemeralMessageParameters"
    )
)
public suspend fun TelegramBot.send(
    chatId: ChatIdentifier,
    ...
    replyParameters: ReplyParameters? = null,
    replyMarkup: KeyboardMarkup? = null
): ChatContentMessage<AnimationContent> = send(
    chatId = chatId,
    animation = animation,
    text = text,
    parseMode = parseMode,
...
public suspend fun TelegramBot.send(
    ...
    replyParameters: ReplyParameters? = null,
    replyMarkup: KeyboardMarkup? = null
): ChatContentMessage<AudioContent> = send(
    chatId = chatId,
    audio = audio,
    text = text,
    parseMode = parseMode,
...
public suspend fun TelegramBot.send(
    ...
    replyParameters: ReplyParameters? = null,
    replyMarkup: KeyboardMarkup? = null
): ChatContentMessage<ContactContent> = send(
    chatId = chatId,
    phoneNumber = phoneNumber,
    firstName = firstName,
    lastName = lastName,
...
public suspend fun TelegramBot.send(
    ...
    replyMarkup: KeyboardMarkup? = null,
    disableContentTypeDetection: Boolean? = null
): ChatContentMessage<DocumentContent> = send(
    chatId = chatId,
    document = document,
    text = text,
    parseMode = parseMode,
...
public suspend fun TelegramBot.send(
    ...
    replyParameters: ReplyParameters? = null,
    replyMarkup: KeyboardMarkup? = null
): ChatContentMessage<StaticLocationContent> = send(
    chatId = chatId,
    latitude = latitude,
    longitude = longitude,
    threadId = threadId,
...
public suspend fun TelegramBot.send(
    ...
    replyParameters: ReplyParameters? = null,
    replyMarkup: KeyboardMarkup? = null
): ChatContentMessage<PhotoContent> = send(
    chatId = chatId,
    photo = photo,
    text = text,
    parseMode = parseMode,
...
public suspend fun TelegramBot.send(
    ...
    replyParameters: ReplyParameters? = null,
    replyMarkup: KeyboardMarkup? = null
): ChatContentMessage<StickerContent> = send(
    chatId = chatId,
    sticker = sticker,
    threadId = threadId,
    directMessageThreadId = directMessageThreadId,
...
public suspend fun TelegramBot.send(
    ...
    replyParameters: ReplyParameters? = null,
    replyMarkup: KeyboardMarkup? = null
): ChatContentMessage<LiveLocationContent> = send(
    chatId = chatId,
    latitude = latitude,
    longitude = longitude,
    livePeriod = livePeriod,
...
public suspend fun TelegramBot.send(
    ...
    suggestedPostParameters: SuggestedPostParameters? = null,
        replyParameters: ReplyParameters? = null,
    replyMarkup: KeyboardMarkup? = null
): ChatContentMessage<VenueContent> = send(
    chatId = chatId,
    latitude = latitude,
    longitude = longitude,
    title = title,
...
public suspend fun TelegramBot.send(
    ...
    replyParameters: ReplyParameters? = null,
    replyMarkup: KeyboardMarkup? = null
): ChatContentMessage<VideoContent> = send(
    chatId = chatId,
    video = video,
    text = text,
    parseMode = parseMode,
...
public suspend fun TelegramBot.send(
    ...
    replyParameters: ReplyParameters? = null,
    replyMarkup: KeyboardMarkup? = null
): ChatContentMessage<LivePhotoContent> = send(
    chatId = chatId,
    livePhoto = livePhoto,
    text = text,
    parseMode = parseMode,
...
public suspend fun TelegramBot.send(
    ...
    replyParameters: ReplyParameters? = null,
    replyMarkup: KeyboardMarkup? = null
): ChatContentMessage<VideoNoteContent> = send(
    chatId = chatId,
    videoNote = videoNote,
    threadId = threadId,
    directMessageThreadId = directMessageThreadId,
...
public suspend fun TelegramBot.send(
    ...
    suggestedPostParameters: SuggestedPostParameters? = null,
        replyParameters: ReplyParameters? = null,
    replyMarkup: KeyboardMarkup? = null
): ChatContentMessage<VoiceContent> = send(
    chatId = chatId,
    voice = voice,
    text = text,
    parseMode = parseMode,

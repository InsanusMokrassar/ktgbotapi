...
public suspend fun TelegramBot.downloadFileStream(filePath: String): ByteReadChannel = downloadFileStreamAllocator(filePath).invoke()

public suspend fun TelegramBot.downloadFileStream(pathedFile: PathedFile): ByteReadChannel = downloadFileStream(pathedFile.filePath)

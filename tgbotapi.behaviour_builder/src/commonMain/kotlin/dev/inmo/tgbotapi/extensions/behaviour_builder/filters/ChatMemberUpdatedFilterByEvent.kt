 ...
 */
val chatMemberJoinedFilter =
    SimpleFilter<ChatMemberUpdated> {
        it.joinedChat
    }
 ...
 */
val chatMemberSubscribedFilter =
    SimpleFilter<ChatMemberUpdated> {
        it.subscribed
    }
 ...
 */
val chatMemberSubscriptionChangedFilter =
    SimpleFilter<ChatMemberUpdated> {
 ...
 */
val chatMemberUnsubscribedFilter =
    SimpleFilter<ChatMemberUpdated> {
        it.unsubscribed
    }
 ...
 */
val chatMemberGotPromotedFilter =
    SimpleFilter<ChatMemberUpdated> {
        it.gotPromoted
    }
 ...
 */
val chatMemberGotPromotionChangedFilter =
    SimpleFilter<ChatMemberUpdated> {
 ...
 */
val chatMemberGotDemotedFilter =
    SimpleFilter<ChatMemberUpdated> {
        it.gotDemoted
    }
 ...
 */
val chatMemberBecameOwnerFilter =
    SimpleFilter<ChatMemberUpdated> {
        it.becameOwner
    }
 ...
 */
val chatMemberCeasedOwnershipFilter =
    SimpleFilter<ChatMemberUpdated> {
        it.ceasedOwnership
    }
 ...
 */
val chatMemberGotRestrictedFilter =
    SimpleFilter<ChatMemberUpdated> {
        it.gotRestricted
    }
 ...
 */
val chatMemberGotRestrictionsChangedFilter =
    SimpleFilter<ChatMemberUpdated> {
 ...
 */
val chatMemberGotUnrestrictedFilter =
    SimpleFilter<ChatMemberUpdated> {
        it.gotUnrestricted
    }

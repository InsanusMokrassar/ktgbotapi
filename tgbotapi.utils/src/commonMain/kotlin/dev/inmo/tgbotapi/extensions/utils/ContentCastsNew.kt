...
inline fun <reified T : MessageContent> ContentMessage<*>.withContentOrNull() =
    if (content is T) {
...
inline fun <reified T : MessageContent> CommonMessage<*>.withContentOrNull() =
    if (content is T) {
...
inline fun <reified T : MessageContent> PossiblySentViaBotCommonMessage<*>.withContentOrNull() =
    if (content is T) {
...
inline fun <reified T : MessageContent> ChannelContentMessage<*>.withContentOrNull() =
    if (content is T) {
...
inline fun <reified T : MessageContent> PrivateContentMessage<*>.withContentOrNull() =
    if (content is T) {
...
inline fun <reified T : MessageContent> PublicContentMessage<*>.withContentOrNull() =
    if (content is T) {
...
inline fun <reified T : MessageContent> GroupContentMessage<*>.withContentOrNull() =
    if (content is T) {
...
inline fun <reified T : MessageContent> FromChannelGroupContentMessage<*>.withContentOrNull() =
    if (content is T) {
...
inline fun <reified T : MessageContent> AnonymousGroupContentMessage<*>.withContentOrNull() =
    if (content is T) {
...
inline fun <reified T : MessageContent> CommonGroupContentMessage<*>.withContentOrNull() =
    if (content is T) {

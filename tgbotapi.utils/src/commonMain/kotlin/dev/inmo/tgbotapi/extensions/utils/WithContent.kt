...
inline fun <reified T : MessageContent> ContentMessage<*>.withContent() =
    if (content is T) {
...
inline fun <reified T : MessageContent> CommonMessage<*>.withContent() =
    if (content is T) {
...
inline fun <reified T : MessageContent> PossiblySentViaBotCommonMessage<*>.withContent() =
    if (content is T) {
...
inline fun <reified T : MessageContent> ChannelContentMessage<*>.withContent() =
    if (content is T) {
...
inline fun <reified T : MessageContent> PrivateContentMessage<*>.withContent() =
    if (content is T) {
...
inline fun <reified T : MessageContent> BusinessContentMessage<*>.withContent() =
    if (content is T) {
...
inline fun <reified T : MessageContent> PublicContentMessage<*>.withContent() =
    if (content is T) {
...
inline fun <reified T : MessageContent> GroupContentMessage<*>.withContent() =
    if (content is T) {
...
inline fun <reified T : MessageContent> FromChannelGroupContentMessage<*>.withContent() =
    if (content is T) {
...
inline fun <reified T : MessageContent> AnonymousGroupContentMessage<*>.withContent() =
    if (content is T) {
...
inline fun <reified T : MessageContent> CommonGroupContentMessage<*>.withContent() =
    if (content is T) {

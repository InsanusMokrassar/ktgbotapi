...
@Suppress("UNCHECKED_CAST")
@RiskFeature(lowLevelRiskFeatureMessage)
inline fun <reified T : MessageContent> Flow<BaseSentMessageUpdate>.filterContentMessages(): Flow<ContentMessage<T>> =
    asContentMessagesFlow().mapNotNull(
...
fun FlowsUpdatesFilter.sentMessages(scopeToIncludeChannels: CoroutineScope? = null): Flow<ContentMessage<MessageContent>> =
    filterContentMessages(scopeToIncludeChannels)

fun Flow<BaseSentMessageUpdate>.animationMessages() = filterContentMessages<AnimationContent>()

fun FlowsUpdatesFilter.animationMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.audioMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.contactMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.diceMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.documentMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.gameMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.invoiceMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.locationMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.photoMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.pollMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.stickerMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.textMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.storyMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.venueMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.videoMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.videoNoteMessages(scopeToIncludeChannels: CoroutineScope? = null) =
...
fun FlowsUpdatesFilter.voiceMessages(scopeToIncludeChannels: CoroutineScope? = null) =

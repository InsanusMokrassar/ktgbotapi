...
open class TelegramBotMiddleware(
    ...
    internal val onAfterCallFactoryMakeCall: (
        suspend (
            result: Any?,
            request: Request<*>,
    ...
    internal val onRequestResultPresented: (
    ...
    internal val onRequestReturnResult: (
        suspend (result: Result<*>, request: Request<*>, callsFactories: List<KtorCallFactory>) -> Result<Any?>?
    )? = null,

...
external class WebApp {
    ...
    fun showPopup(
        params: PopupParams,
        callback: ClosePopupCallback? = definedExternally,
    )

    fun showAlert(
        message: String,
        callback: AlertCallback? = definedExternally,
    )

    fun showConfirm(
        message: String,
        callback: ConfirmCallback? = definedExternally,
    )

    fun showScanQrPopup(
        params: ScanQrPopupParams,
        callback: QRTextReceivedCallback? = definedExternally,
    )
    ...
    @JsName("offEvent")
    fun offEventWithViewportChangedData(
        type: String,
        callback: (ViewportChangedData) -> Unit,
    )

    @JsName("offEvent")
    fun offEventWithInvoiceClosedInfo(
        type: String,
        callback: (InvoiceClosedInfo) -> Unit,
    )
    ...
    fun openInvoice(
        url: String,
        callback: (InvoiceClosedInfo) -> Unit = definedExternally,
    )

    fun shareToStory(
        mediaUrl: String,
        params: StoryShareParams? = definedExternally,
    )
    ...
    @JsName("onEvent")
    internal fun onEmojiStatusAccessRequested(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgStatusObject) -> Unit,
    )

    @JsName("onEvent")
    internal fun onAccelerometerChanged(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onDeviceOrientationStarted(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onEmojiStatusFailed(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgErrorObject) -> Unit,
    )
    ...
    @JsName("onEvent")
    internal fun onShareMessageSent(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onLocationManagerUpdated(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onBiometricTokenUpdated(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgIsUpdatedObject) -> Unit,
    )

    @JsName("onEvent")
    internal fun onDeviceOrientationFailed(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgErrorObject) -> Unit,
    )

    @JsName("onEvent")
    internal fun onSafeAreaChanged(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onWriteAccessRequested(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgStatusObject) -> Unit,
    )

    @JsName("onEvent")
    internal fun onContentSafeAreaChanged(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onAccelerometerStarted(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onAccelerometerStopped(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onPopupClosed(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.popup.PopupClosedEventArg) -> Unit,
    )

    @JsName("onEvent")
    internal fun onGyroscopeStopped(
        type: String,
        callback: () -> Unit,
    )
    ...
    @JsName("onEvent")
    internal fun onHomeScreenAdded(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onShareMessageFailed(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgErrorObject) -> Unit,
    )
    ...
    @JsName("onEvent")
    internal fun onBiometricManagerUpdated(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onScanQrPopupClosed(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onBiometricAuthRequested(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgBiometricAuthRequested) -> Unit,
    )

    @JsName("onEvent")
    internal fun onHomeScreenChecked(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgStatusObject) -> Unit,
    )

    @JsName("onEvent")
    internal fun onLocationRequested(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgLocationDataObject) -> Unit,
    )

    @JsName("onEvent")
    internal fun onSecondaryButtonClicked(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onQrTextReceived(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgDataObject) -> Unit,
    )

    @JsName("onEvent")
    internal fun onEmojiStatusSet(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onFullscreenFailed(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgErrorObject) -> Unit,
    )

    @JsName("onEvent")
    internal fun onGyroscopeFailed(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgErrorObject) -> Unit,
    )

    @JsName("onEvent")
    internal fun onSettingsButtonClicked(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onDeactivated(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onDeviceOrientationStopped(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onFullscreenChanged(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onViewportChanged(
        type: String,
    ...
    @JsName("onEvent")
    internal fun onAccelerometerFailed(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgErrorObject) -> Unit,
    )

    @JsName("onEvent")
    internal fun onClipboardTextReceived(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgDataNullableObject) -> Unit,
    )

    @JsName("onEvent")
    internal fun onFileDownloadRequested(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgStatusObject) -> Unit,
    )

    @JsName("onEvent")
    internal fun onContactRequested(
        type: String,
        callback: (dev.inmo.tgbotapi.webapps.args.ArgStatusObject) -> Unit,
    )

    @JsName("onEvent")
    internal fun onInvoiceClosed(
        type: String,
        callback: (String, String) -> Unit,
    )

    @JsName("onEvent")
    internal fun onGyroscopeStarted(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onGyroscopeChanged(
        type: String,
        callback: () -> Unit,
    )

    @JsName("onEvent")
    internal fun onDeviceOrientationChanged(
        type: String,
        callback: () -> Unit,
    )

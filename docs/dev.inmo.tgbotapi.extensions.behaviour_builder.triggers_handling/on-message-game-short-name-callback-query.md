//[docs](../../index.md)/[dev.inmo.tgbotapi.extensions.behaviour_builder.triggers_handling](index.md)/[onMessageGameShortNameCallbackQuery](on-message-game-short-name-callback-query.md)

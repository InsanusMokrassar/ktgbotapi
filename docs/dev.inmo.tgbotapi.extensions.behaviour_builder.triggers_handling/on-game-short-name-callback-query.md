//[docs](../../index.md)/[dev.inmo.tgbotapi.extensions.behaviour_builder.triggers_handling](index.md)/[onGameShortNameCallbackQuery](on-game-short-name-callback-query.md)

//[docs](../../../index.md)/[dev.inmo.tgbotapi.types.message.content.abstracts](../index.md)/[DocumentMediaGroupContent](index.md)



# DocumentMediaGroupContent  
 [common] interface [DocumentMediaGroupContent](index.md) : [MediaGroupContent](../-media-group-content/index.md)   
...
|  Name | 
|---|
| <a name="dev.inmo.tgbotapi.types.message.content.media/DocumentContent///PointingToDeclaration/"></a>[DocumentContent](../../dev.inmo.tgbotapi.types.message.content.media/-document-content/index.md)|
